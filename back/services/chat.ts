...
// eslint-disable-next-line @typescript-eslint/no-unused-vars -- kept for guarded-transfer attestation wiring.
    ...
    try {
      ...
      return jsonResponse({
        ...
        swap_execution: {
          ...
          quote: (swapArgs as OrcaSwapParams & { quote?: OrcaSwapQuote }).quote ?? null,
        },
        transaction: {
